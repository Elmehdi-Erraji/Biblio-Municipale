                                    ...
                                    <div class="col-lg-6">
                                        <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" id="addBookForm">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="published_at" type="date" class="form-control @error('published_at') is-invalid @enderror" name="published_at" value="{{ old('published_at') }}" >
                                                    @error('published_at')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="totalCopies" type="number" class="form-control @error('totalCopies') is-invalid @enderror" name="totalCopies" value="{{ old('totalCopies') }}" >
                                                    @error('totalCopies')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="availableCopies" type="number" class="form-control @error('availableCopies') is-invalid @enderror" name="availableCopies" value="{{ old('availableCopies') }}" >
